...
// Update generateComplaintObject and generateFeelingObject to be consistent with JSON obj.
  // Write function to add completed object to JSON object
  // implement ability to add word to local storage with content generated by openAI API
